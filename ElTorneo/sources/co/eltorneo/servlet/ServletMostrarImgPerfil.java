 ...
 */
@WebServlet(name = "ServletMostrarImgPerfil", urlPatterns = {"/ServletMostrarImgPerfil"})
public class ServletMostrarImgPerfil extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try {
                ...
                is = new BufferedInputStream(new FileInputStream(pathToWeb + "default.png"));
            }
